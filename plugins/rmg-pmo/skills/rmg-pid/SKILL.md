...
The context file is `<PMO folder>/projects/PRJ00xxx.NAME/project-context.md`,
where `<PMO folder>` is the folder holding `Context/Templates/` (normally
`RMG Skills`). If the project folder does not exist, create it and seed the
